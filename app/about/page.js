...
const pillars = [
  ...
  },
  {
    ...
    description:
      "While we are new, we have brothers who have interned / worked at various companies such as Vanguard, Fidelity, Nokia, and more, and we plan on building our Alumni Network as time goes by.",
  ...
  },
  {
    ...
    description:
      "KTP is an inclusive fraternity that recruits the best in tech, encouraging all members to bring their authentic selves.",
      ...
      <Container sx={{ marginTop: 15 }}>
        ...
        <Grid container spacing={4} alignItems="center" sx={{ marginTop: 5 }}>
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              As one of the founding members of this chapter, it's been an
              incredible journey watching our vision come to life. We
              established a solid foundation in our inaugural year, and now
            ...
            <Typography
              ...
              sx={{ color: "white", mb: 3, fontSize: "1.25rem" }}
            >
              The opportunities within Kappa Theta Pi are truly limitless. This
              past year has exceeded every expectation I had when we first
              started this chapter. It pushed me beyond my comfort zone,
              connected me with an incredible network of tech-minded
              individuals, expanded my technical skills, and introduced me to
              friends I know I'll have for life. What continues to amaze me is
              the caliber of companies where our brothers are making their mark
              — from innovative startups to Fortune 500 tech giants, our members
              are contributing to some of the most exciting organizations in the
              industry.
            </Typography>
            <Typography
              variant="body1"
            ...
            >
              This fraternity has transformed me in ways I never anticipated.
              Professionally, it's sharpened my technical abilities, taught me
              invaluable leadership skills, and opened doors I didn't even know
              existed. The mentorship from brothers and the collaborative
              projects we tackle together have accelerated my growth
              exponentially. Personally, Kappa Theta Pi has made me more
              confident, more resilient, and more connected to a purpose greater
              than myself. The bonds we share push each of us to be our best
              selves, creating a culture where excellence isn't just encouraged
              — it's expected.
            </Typography>
            <Typography
              variant="body1"
              sx={{ color: "white", mb: 3, fontSize: "1.25rem" }}
            >
              I've had the privilege of watching some of Alpha Beta's most
              talented and driven members flourish, and I'm thrilled to see what
          ...
          <Grid container spacing={4} alignItems="center">
            ...
            <Grid item xs={12} md={6}>
              ...
              <Typography
                variant="body1"
                gutterBottom
                sx={{ color: "white", fontSize: "1.25rem", mb: 2 }}
              >
                KTP was founded on January 10, 2012, in Ann Arbor, Michigan, as
                the University of Michigan&apos;s first professional technology
                fraternity.
              </Typography>
              <Typography
                variant="body1"
              ...
              >
                ...
                various fields such as Informatics, computer science, business,
              ...
              <Typography
                ...
                sx={{ color: "white", fontSize: "1.25rem", mb: 2 }}
              >
                Our goal is to develop networks through professional and social
                growth while exposing members to career opportunities in the
                tech industry.
              </Typography>
              <Typography
                variant="body1"
